...
@mcp.tool(description="调用DescribeVpnConnectionAttributes查询指定的IPsec连接")
@handle_errors
...
@mcp.tool(description="调用DescribeVpnGatewayAttributes查看指定VPN网关的信息")
@handle_errors
...
@mcp.tool(description="调用DescribeSslVpnClientCertAttributes查询指定SSL客户端证书信息")
@handle_errors
...
@mcp.tool(description="调用DescribeVpnGatewayRoutes按条件查询VPN网关的目的路由条目")
@handle_errors
...
@mcp.tool(description="调用DescribeVpnConnections查询满足指定条件的IPsec连接")
@handle_errors
...
@mcp.tool(description="调用DescribeVpnGateways查询满足指定条件的VPN网关")
@handle_errors
...
@mcp.tool(description="调用DescribeCustomerGateways按指定条件查询用户网关")
@handle_errors
...
@mcp.tool(description="调用DescribeSslVpnClientCerts查询SSL客户端证书详情列表")
@handle_errors
...
@mcp.tool(description="调用DescribeSslVpnServers查询SSL服务端信息")
@handle_errors
